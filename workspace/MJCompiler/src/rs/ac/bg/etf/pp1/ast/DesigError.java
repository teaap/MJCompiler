...
public class DesigError extends Designator {
    ...
    public DesigError (DesigIdent DesigIdent, Expr Expr, Expr Expr1, Expr Expr2, BrackDesig BrackDesig) {
